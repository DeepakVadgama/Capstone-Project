...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class NotificationPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            final String ringtonePrefKey = getActivity().getString(R.string.notifications_ringtone);
            bindPreferenceSummaryToValue(findPreference(ringtonePrefKey));
        }
    ...
    public static class DataSyncPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            final String sync_frequency = getActivity().getString(R.string.sync_frequency);
